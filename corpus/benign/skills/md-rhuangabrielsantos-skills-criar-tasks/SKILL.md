---
name: criar-tasks
description: Cria as TASKS seguindo um template definido utilizando a prd e a techspec como referencias
---
...
- Template para a lista de tarefas: `./references/tasks-template.md`
- Lista de tarefas: `./tasks/prd-[nome-funcionalidade]/tasks.md`
- Template para cada tarefa individual: `./references/task-template.md`
