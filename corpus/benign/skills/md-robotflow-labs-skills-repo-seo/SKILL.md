...
version: 1.0.0
description: |
  SEO content audit — on-page SEO checklist, E-E-A-T assessment, keyword analysis,
  technical SEO, content gap analysis, schema markup, and Core Web Vitals.
  Produces SEO-AUDIT.md. Use via /marketing seo <url>.
allowed-tools:
  - Bash
  - Read
  - WebFetch
