...
- **Directive:** `systems/doe-engine/directives/seo-fundamentals.md` — read and follow for process.
- Run directive check; report "DIRECTIVE FOUND: seo-fundamentals.md" or "NO DIRECTIVE FOUND."
- Align with `master-website-directive.md` for website builds (SEO is a non-negotiable there).
