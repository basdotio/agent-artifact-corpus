...
| Duplication & integrity | exact and near duplicates, cross-class contamination, byte integrity against pinned upstreams | all 3,481 trees; 6,084,816 pairs exactly |
...
- **`leakage active over 3481 samples`** reported the corpus's size as if it were the gate's
