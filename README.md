...
|---|---|---|
| [`aguard`](https://github.com/basdotio/agent-guard) | yes, on 6 of the 3,524 layer-1 samples | the only one so far — see *Known gaps* |
...
- **Rule ids in `expect.<tool>` blocks are not verified here, by design.** 6 of 3,524 labels
